...
export default class Charts extends Vue {
  ...
  drawChart() {
    let charts = echarts.init((this as any).$refs.mychart as HTMLCanvasElement)
    if (charts == undefined) {
      return
    }
    ...
    switch (this.chartType) {
      case 'line':
        charts.setOption((this as any).generatorLineOption())
        break
      case 'bar':
        charts.setOption((this as any).generatorBarOption())
        break
      case 'pie':
        charts.setOption((this as any).generatorPieOption())
        break
      // default:
      //     break;
    }
