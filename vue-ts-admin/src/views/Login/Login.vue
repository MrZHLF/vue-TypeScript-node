<template>
  <div class="login">
    <LoginHeader>
      <el-form slot="container" :model="ruleForm" label-position="left" label-width="0px" :rules="rules" ref="ruleForm">
        <div class="title">
          <h3>账号密码登录</h3>
        </div>
        <!-- username -->
        ...
        <!-- 7天登录，忘记密码 -->
        <el-form-item>
          <el-checkbox v-model="ruleForm.autoLogin" :checkout="ruleForm.autoLogin">7天内自动登录</el-checkbox>
